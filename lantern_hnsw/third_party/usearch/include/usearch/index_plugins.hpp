...
class i8_converted_t {
  ...
  public:
    ...
    inline i8_converted_t(float v)
        : int8_(static_cast<std::int8_t>(usearch::clamp<float>(v * divisor_k, min_k, max_k))) {}
    inline i8_converted_t(double v)
        : int8_(static_cast<std::int8_t>(usearch::clamp<double>(v * divisor_k, min_k, max_k))) {}
};
  ...
  private:
    ...
    void configure_with_auto_vectorized() noexcept {
        ...
        case metric_kind_t::cos_k: {
            ...
            case scalar_kind_t::b1x8_k: raw_ptr_ = (punned_ptr_t)&equidimensional_<metric_hamming_gt<b1x8_t>>; break;
            default: raw_ptr_ = nullptr; break;
            }
            break;
        }
